...
const ItemSearchPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen  bg-gradient-to-b from-gray-50 to-gray-100 dark:from-slate-900 dark:to-slate-900">
      ...
      <div className="bg-white max-w-9xl mx-auto px-10 lg:px-20 dark:bg-slate-800 shadow-sm border-b border-gray-200 dark:border-slate-700 sticky top-0 z-40">
      ...
      {/* Main Content */}
      <div className="w-full" style={{ maxWidth: '1536px', margin: '0 auto', paddingLeft: '2.5rem', paddingRight: '2.5rem', paddingTop: '2rem', paddingBottom: '2rem' }}>
