            ...
            <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
              <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div className="flex items-center justify-between mb-4">
                  <h3 className="text-lg font-medium text-gray-900">Trigger Risk Enforcement</h3>
                  <button
                    type="button"
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-md p-4">
                      <div className="flex">
                        ...
                        <div className="ml-3">
                          <h4 className="text-sm font-medium text-green-800">Enforcement Triggered</h4>
                    ...
                    <div className="bg-gray-50 rounded-md p-4">
                      <h4 className="text-sm font-medium text-gray-900 mb-3">Compliance Details</h4>
                      
                      <div className="grid grid-cols-2 gap-4 mb-4">
                        <div>
                          <label className="text-xs font-medium text-gray-500">Booking ID</label>
                          <p className="text-sm text-gray-900">{result.data.compliance.bookingId}</p>
                        </div>
                        <div>
                          <label className="text-xs font-medium text-gray-500">Product ID</label>
                          <p className="text-sm text-gray-900">{result.data.compliance.productId}</p>
                        </div>
                        <div>
                          <label className="text-xs font-medium text-gray-500">Renter ID</label>
                          <p className="text-sm text-gray-900">{result.data.compliance.renterId}</p>
                        </div>
                        <div>
                          <label className="text-xs font-medium text-gray-500">Violations Recorded</label>
                          <p className="text-sm text-gray-900">{result.data.violationsRecorded}</p>
                        </div>
                      </div>

                      <div className="grid grid-cols-2 gap-4 mb-4">
                        <div>
                          <label className="text-xs font-medium text-gray-500">Compliance Status</label>
                        ...
                        <div>
                          <label className="text-xs font-medium text-gray-500">Compliance Score</label>
                      ...
                      {result.data.compliance.missingRequirements.length > 0 && (
                        <div className="mb-4">
                          <label className="text-xs font-medium text-gray-500">Missing Requirements</label>
                      ...
                      {result.data.compliance.enforcementActions.length > 0 && (
                        <div className="mb-4">
                          <label className="text-xs font-medium text-gray-500">Enforcement Actions</label>
                      ...
                      <div>
                        <label className="text-xs font-medium text-gray-500">Last Checked</label>
