        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-2">
          <div className="flex items-center space-x-2.5 sm:space-x-3">
            ...
            <div className="min-w-0">
              <h2 className="text-sm sm:text-base md:text-lg font-medium text-gray-900 dark:text-slate-100"><TranslatedText text="Compliance Checker" /></h2>
              <p className="text-xs sm:text-sm text-gray-600 dark:text-slate-400"><TranslatedText text="Check booking compliance status" /></p>
            </div>
          </div>
          {compliance && (
        ...
        <form onSubmit={handleCheckCompliance} className="space-y-4 sm:space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            <div className="relative">
              <label htmlFor="booking" className="block text-xs sm:text-sm font-medium text-gray-700 mb-2 dark:text-slate-300">
          ...
          <div className="flex flex-col sm:flex-row justify-end gap-2 sm:gap-3 sm:space-x-3">
            <button
              ...
              className="inline-flex items-center justify-center px-4 sm:px-5 py-2.5 sm:py-2 border border-gray-300 rounded-lg sm:rounded-md shadow-sm text-xs sm:text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 active:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 disabled:opacity-50 disabled:cursor-not-allowed dark:border-slate-700 dark:text-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 dark:active:bg-slate-600 touch-manipulation min-h-[44px] sm:min-h-0 transition-colors w-full sm:w-auto"
            >
