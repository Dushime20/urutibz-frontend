...
import { BarChart3, Calendar, Car, Wallet, Shield, BookOpen, Settings, MessageCircle } from 'lucide-react';

type TabKey = 'overview' | 'bookings' | 'listings' | 'wallet' | 'inspections' | 'reviews' | 'messages' | 'settings';
