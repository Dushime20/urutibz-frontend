        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <Link to="/" className="inline-block mb-6">
              <img src="/assets/img/yacht/urutilogo2.png" alt={platform?.siteName || 'UrutiBz'} className="h-10 w-auto object-contain drop-shadow" />
            </Link>
            <p className="text-white/80 mb-4">
              {(platform?.siteDescription) || 'UrutiBz is your AI-powered, international rental platform. Rent anything, anytime—photography, electronics, tools, sports, home, vehicles, and more.'}
            </p>
            <div className="flex space-x-4 mt-4">
              {/* Social icons from business settings */}
              {business?.socialMedia?.facebook && (
                <a href={business.socialMedia.facebook} target="_blank" rel="noreferrer" className="text-white/60 hover:text-white transition-colors duration-200" aria-label="Facebook">
              ...
              {business?.socialMedia?.twitter && (
                <a href={business.socialMedia.twitter} target="_blank" rel="noreferrer" className="text-white/60 hover:text-white transition-colors duration-200" aria-label="Twitter">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-twitter"><path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"></path></svg>
                </a>
              )}
              {business?.socialMedia?.instagram && (
                <a href={business.socialMedia.instagram} target="_blank" rel="noreferrer" className="text-white/60 hover:text-white transition-colors duration-200" aria-label="Instagram">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-instagram"><rect x="2" y="2" width="20" height="20" rx="5" ry="5"></rect><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"></path><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"></line></svg>
                </a>
              )}
              {business?.socialMedia?.linkedin && (
                <a href={business.socialMedia.linkedin} target="_blank" rel="noreferrer" className="text-white/60 hover:text-white transition-colors duration-200" aria-label="LinkedIn">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start">
                ...
                <span className="text-white/80">{platform?.contactPhone || business?.contactInfo?.phone || 'International: +250 788 123 456'}</span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">✉</span>
                <span className="text-white/80">{platform?.contactEmail || business?.contactInfo?.email || 'support@urutibz.com'}</span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">🕒</span>
