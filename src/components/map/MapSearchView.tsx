    ...
    <>
      ...
      <div
        className={`hidden md:flex ${
          sidebarOpen ? 'w-[500px] lg:w-[600px]' : 'w-0'
        } bg-white dark:bg-gray-900 transition-all duration-300 ease-in-out overflow-hidden flex-col border-r border-gray-200 dark:border-gray-800 z-[1001]`}
      >
        {sidebarOpen && (
        ...
        <div className="absolute top-4 left-4 z-[1000] flex flex-col gap-2">
          ...
          {onLocationSelect && (
            <button
              ...
              className="bg-white dark:bg-gray-900 rounded-full px-3 md:px-4 py-2 md:py-2.5 shadow-lg border border-gray-200 dark:border-gray-800 hover:shadow-xl transition-all text-xs md:text-sm font-semibold text-gray-900 dark:text-white whitespace-nowrap"
            >
          ...
          <button
            ...
            className="bg-white dark:bg-gray-900 rounded-full p-2.5 md:p-3 shadow-lg border border-gray-200 dark:border-gray-800 hover:shadow-xl transition-all disabled:opacity-50"
            title="My location"
          >
      ...
      {isMobile && (
        <div className={`md:hidden fixed left-1/2 transform -translate-x-1/2 z-[1003] flex gap-2 transition-all duration-300 ${
          bottomSheetOpen && viewMode === 'list' ? 'bottom-4' : 'bottom-4'
        }`}>
          <button
            onClick={() => {
              setViewMode('list');
            ...
            className={`px-6 py-3 rounded-full shadow-lg font-semibold text-sm transition-all ${
              viewMode === 'list'
